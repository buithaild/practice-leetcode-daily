...
class RandomizedSet:
    ...
    def insert(self, val: int) -> bool:
        if val in self.values_map:
            return False
        self.values_map[val] = len(self.values) #Vi tri de add
    ...
    def remove(self, val: int) -> bool:
        ...
        index = self.values_map[val]
        last_value = self.values[-1]
        self.values_map[last_value] = index #Update vi tri cua last_value
...
if __name__ == '__main__':
    ...
    res.append(randomizedSet.insert(1))
    res.append(randomizedSet.remove(2))
    res.append(randomizedSet.insert(2))
    res.append(randomizedSet.getRandom())
    res.append(randomizedSet.remove(1))
    res.append(randomizedSet.insert(2))
    res.append(randomizedSet.getRandom())
    print(res)
